...
<div class="max-w-xl mx-auto py-10 px-4">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">➕ Registrar Nueva Habitación</h1>

    <form action="{{ route('rooms.store') }}" method="POST" class="bg-white shadow-md rounded-xl px-8 pt-6 pb-8">
        @csrf
        ...
        <div class="flex justify-between items-center">
            <a href="{{ route('rooms.index') }}" class="text-sm text-gray-600 hover:text-gray-900">← Volver</a>
            <button type="submit"
